...
categories <- c(names(wordlists)[grep("EN__", names(wordlists))], 
                names(wordlists)[grep(c("heat_sector|electricity_sector"), names(wordlists))],
                names(wordlists)[grep(c("industrial_production_intermediate_produ|heavy_industry|public_illumination|ETCS__economy_general|food_processing_consumption|commercial_sector_unspecific|industrial_sector_incl_company|residential_area|commerce_sales"), names(wordlists))])
...
categories <- categories[-c(grep("EN__general", categories))]
...
rows.ordered <- c(grep(".*resources.*~~", row.names(result.energychain )),
                  ...
                  grep(".*__SUST__.*sector.*~~", row.names(result.energychain )),
                  ...
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(residential_area)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(public_illumination)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(commercial_sector_unspecific)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(commerce_sales)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(food_processing_consumption)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(economy_general)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(industrial_production_intermediate_produ)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(industrial_sector_incl_company)((?!~~).)*$", row.names(result.energychain), perl=TRUE),
                  grep("(^c[\\d]+)(__EN__spec)([\\w]+)(heavy_industry)((?!~~).)*$", row.names(result.energychain), perl=TRUE)#,
...
for (i in seq(length(maincategories))) {
  ...
  } else if(grepl("__SUST__.*sector",  maincategories[i]) == TRUE) {
    c("_sector") 
...
x.axis.label.size <- c(12)
y.axis.label.size <- c(10)
y.axis.title.size <- c(12)
annotate.label.size <-c(4)
